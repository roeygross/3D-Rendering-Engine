    ...
    void DOF1() {
       ...
       /* scene.geometries.add(
        ...
        scene.geometries.add(
                ...
                //little wall in middle
                , new Floor(new Point(-900, 0, 0), new Vector(0, 0, 1), new Vector(0, 1, 0),
                        GRAY, LIGHTGRAY, 125, 1200, 15, 15, new Material().setKd(0.1).setKs(0.1).setkT(0.1)).getElements()
                //walls behind camera
                , new Floor(new Point(-1900, 0, 0), new Vector(0, 0, 1), new Vector(0, 1, 0),
                        RED, YELLOW, 2000, 2000, 20, 20, new Material()).getElements()
                , new Floor(new Point(0, 2000, 0), new Vector(0, 0, 1), new Vector(-1, 0, 0),
        ...
        camera.setAntiAliasing(AntiAliasing.DOF).setDOFPlaneDistance(1500).setAperture(10).setintervalThread(0.1).setThreads(3);
        camera.setImageWriter(new ImageWriter("roomImageDOF1", 500, 500)) //
                .setRayTracer(new RayTracerBasic(scene)) //
                .renderImage() //
                .writeToImage();
    }
