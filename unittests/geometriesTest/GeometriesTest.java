...
class GeometriesTest {
    ...
    void testFindIntsersections() {
        ...
        assertEquals(
                3,
                geometries.findIntersection(new Ray(new Point(3.48912607502429, 2.492278904234482, 0),new Vector(-4.771313818529334,-2.5410518459516,3.328440304229791))).size(),
                "Geometries findintersection doesnt work"
        );
        // =============== empty list Boundary Value Test ==================
        assertTrue(
                new Geometries().findIntersection(new Ray(new Point(3.48912607502429, 2.492278904234482, 0),new Vector(-4.771313818529334,-2.5410518459516,3.328440304229791)))==null,
                "Geometries findintersection doesnt work"
        );
        ...
        assertEquals(
                0,
                geometries.findIntersection(new Ray(new Point(0,0,2),new Vector(0,0,1))).size(),
                "Geometries findintersection doesnt work"
        );
        ...
        assertEquals(
                1,
                geometries.findIntersection(new Ray(new Point(0,0,-1),new Vector(0, 3.020864137250663, 1.510432068625332))).size(),
                "Geometries findintersection doesnt work"
        );
        ...
        assertEquals(
                4,
                geometries.findIntersection(new Ray(new Point(0,0,-1),new Vector(0.062848082875715, 1.615620336328068, 1.78553276187449))).size(),
                "Geometries findintersection doesnt work"
        );
    }
}